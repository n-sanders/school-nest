window.StThemes = (function () {
  ...
  const themes = {
    ...
    dragon_fire: {
      ...
      error: "#ffb224",
      errorExtra: "#d48806",
      colorfulError: "#ffb224",
      colorfulErrorExtra: "#d48806",
    },
    sunset_harbor: {
      bg: "#10233a",
      main: "#f5923e",
      ...
      error: "#ff6b6b",
      errorExtra: "#d64545",
      colorfulError: "#ffd43b",
      colorfulErrorExtra: "#e0b400",
    },
    deep_ocean: {
      bg: "#0a1a20",
      main: "#45c4d9",
    ...
    galaxy: {
      ...
      error: "#ff7eb6",
      errorExtra: "#d1477f",
      colorfulError: "#ff7eb6",
      colorfulErrorExtra: "#d1477f",
    },
    graphite: {
      bg: "#1e1e1e",
      main: "#d4d4d4",
    ...
    lemonade: {
      ...
      error: "#dc2626",
      errorExtra: "#991b1b",
      colorfulError: "#e11d48",
      colorfulErrorExtra: "#be123c",
    },
    sky: {
      bg: "#eff6ff",
      main: "#2563eb",
    ...
    coffee_cream: {
      ...
      error: "#b42318",
      errorExtra: "#7a180f",
      colorfulError: "#b45309",
      colorfulErrorExtra: "#8a3e06",
    },
  };
  ...
  const fonts = {
    ...
    chunky: {
      display: '"Chewy", "Segoe UI", cursive',
      body: '"Nunito", "Segoe UI", sans-serif',
    },
    neat_notes: {
      display: '"Patrick Hand", "Segoe UI", cursive',
      body: '"Patrick Hand", "Segoe UI", cursive',
    },
  };
